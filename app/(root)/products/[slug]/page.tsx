...
const ProductDetails = async ({ searchParams }: {
    ...
    try {
        ...
        return (
            <div className='w-full main flex-auto flex justify-center items-center h-full'>
                <p className='text-lg font-semibold'>Invalid product data</p>
            </div>
        );
    }
                ...
                <div className="p-2 sm:p-4 bg-white rounded-lg shadow-4xl">
                    <div className="grid grid-cols-1 sm:grid-cols-3 sm:gap-4 rounded-lg">
                        <div className='col-span-1 aspect-4/3 relative'>
                            ...
                            <Image
                                src={data.imageURL && isValidImageSrc(data.imageURL) ? data.imageURL : "/assets/slider/01.png"}
                                fill
                                alt='product'
                        ...
                        <div className="flex flex-col gap-4 col-span-2">
                            <article className="text-sm text-darker-300 leading-[1.8] ">
                                ...
                                <div className="flex flex-col sm:flex-row w-full my-4 gap-0 sm:gap-2">
                                    ...
                                    <span className="font-medium text-sm line-through text-gray-300">{data.price} SAR</span>
                                </div>
                                <p>
                                    {data.description}
                                </p>
